...
namespace Antignis.Client.Core.Net
{
    internal static class Util
    {
        ...
        internal static string GetHostIPAddress()
        {
            ...
            System.Text.RegularExpressions.Regex r = new System.Text.RegularExpressions.Regex("^(?:ethernet|wi-?fi)\\s?\\d{0,3}$",
            ...
            try
            {
                ...
                {
                    if (r.IsMatch(adapter.Name.ToLower()))
                    {
        ...
        /// <summary>
        /// Determines if IP is for localhost
        /// </summary>
        /// <param name="ip"></param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <returns></returns>
        internal static int[] GetRCEPorts(bool extensive = false)
        {
        ...
        internal static string GetFQDN()
        {
            ...
            return hostName.TrimEnd('.');                    // return the fully qualified name
        }
    }
}
